...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2024 a las 20:12:53
...
('ET', 'encargado de prueba', '$2y$10$/Yh6Y1CsA/IyaEhRv.2kVe6YVtWWazOQXn3lWWkDLB5h/teiVCqTi', 2, 1),
('Laura', 'Laura VazXX', '789', 2, 1),
('Marcos', 'Marcos Cesar', '123', 1, 1),
('MRR', 'Manuel Ruiz Ramirez', '$2y$10$Ij9KNEaDi7Cym8qy.W6qZ.4/YcFmETLyOa0Znhz/es5cZpWj9Nw2a', 3, 1),
...
--
-- Volcado de datos para la tabla `usuario_check`
--

INSERT INTO `usuario_check` (`id`, `user_check`, `check_user`, `turno`) VALUES
(3, 'Domino', 7, 3);
