<?php
//Archivo de menu principal para el encargado, todos sus privilegios está TBD, pero debe poder acceder a evaluaciones
...
<head>
    ...
    <title>Menu principal de encargado</title>
    <!-- Bootstrap CSS -->
